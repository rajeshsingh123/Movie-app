...
class MoviesList extends Component {
    ...
    async componentDidMount() {
        ...
        const res = await axios.get('https://api.themoviedb.org/3/movie/popular?api_key=176960eda5656424e2b90dc44ec1bfcb&language=en-US&&page=${this.state.currPage}')
    ...
    render() {
        ...
        return (
            <>
                <div>
                    <h3 className="text-center" style={{ marginTop: '3rem' }}><strong>Trending</strong></h3>
                </div>
