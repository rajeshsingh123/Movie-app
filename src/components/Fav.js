...
class Fav extends Component {
    ...
    handleDelete = (movieobj)=>{
       ...
       // localStorage.setItem("movies-app",JSON.stringify(oldData));
     //   {()=>this.handleChangeGenre(movieobj.genre_ids[0])}
                            ...
                            <tbody>
                                {
                                    this.state.movies.map((movieEle) => (
                                        <tr>
                                            <th scope="row"><img style={{ width: "3rem", padding: "1rem" }} src={`https://image.tmdb.org/t/p/original${movieEle.backdrop_path}`} />{movieEle.title}</th>
